"""
base_repositorio_sqlserver.py — Clase base con lógica SQL para SQL Server.
...
class BaseRepositorioSqlServer:
    """Clase base con la lógica SQL de SQL Server. Los repositorios específicos heredan de esta clase."""

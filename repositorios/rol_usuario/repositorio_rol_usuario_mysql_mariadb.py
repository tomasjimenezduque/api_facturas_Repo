"""Repositorio de rol_usuario para MySQL/MariaDB."""

from repositorios.base_repositorio_mysql_mariadb import BaseRepositorioMysqlMariaDB


class RepositorioRolUsuarioMysqlMariaDB(BaseRepositorioMysqlMariaDB):
    """Acceso a datos de rol_usuario en MySQL/MariaDB."""

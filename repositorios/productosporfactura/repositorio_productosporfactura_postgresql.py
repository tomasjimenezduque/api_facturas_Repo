"""Repositorio de productosporfactura para PostgreSQL."""

from repositorios.base_repositorio_postgresql import BaseRepositorioPostgreSQL


class RepositorioProductosPorFacturaPostgreSQL(BaseRepositorioPostgreSQL):
    """Acceso a datos de productosporfactura en PostgreSQL."""
